...
<body>
	...
	<!-- Start course Area -->
	<section class="course-area section-gap" style="padding-bottom: 30px; visibility: hidden;" id="course">
		<div class="container">
			<div class="row d-flex justify-content-center">
				...
				<div class="col-lg-8"
					...
					<div
						...
						<div style="display: flex; flex: 1; flex-direction: column;">
							<label style="color: grey; font-size: 13px;">Date</label> <label
					...
					<div
						...
						<div style="display: flex; align-items: center;">
							...
							<label id="buy-qty"
								style="font-size: 18px; user-select: none; margin: 5px 25px; vertical-align: middle;">1</label>
							<label id="btn-plus" onclick="changeQty(1)"
								style="font-size: 28px; font-weight: bold; color: #6c5dd4; margin: 5px 10px; vertical-align: middle; padding: 5px 10px; user-select: none;">+</label>
							<button id="btn-cart"
	...
	<div id="detail" style="width: 70%; text-align: center; visibility: hidden; margin: 50px auto 120px auto;">
		<div style="display: flex; flex: 1; flex-direction: row; justify-content: space-between;">
			<div style="display: flex; flex-direction: column; align-items: space-between; text-align: left; justify-content: center;">
				<h2 style="user-select: none;"><span style="cursor: pointer;" id="btn-detail" onclick="showDetail()">Book Detail</span> <span style="cursor: pointer; margin-left: 150px; color: grey;" id="btn-review" onclick="showReview()">Reviews</span></h2>
				<div style="display: flex; margin-top: 50px; margin-left: 30px; flex-direction: row; color: black;">
					<div style="display: flex; flex-direction: column; justify-content: center; font-size: 16px; font-weight: bold;">
						<label>Title</label>
						<hr>
						<label>ISBN No</label>
						<hr>
					...
					<div style="display: flex; margin-left: 200px; flex-direction: column; justify-content: center; font-size: 16px;">
		...
		$(document).ready(function() {
			...
			.then(data => {
				...
				if(status == "serverError") {
					...
					$('#book-publicationdate').html(list[0].publicationDate);

...
//								// sanitizing output by escaping html special characters
//								genreData = new Genre();
//								genreData.setGenreID(rs.getInt("GenreID"));
//								genreData.setGenre(StringEscapeUtils.escapeHtml4(rs.getString("Genre")));
//								break;
//							}
//
...
//				tempgenre.setGenre(genre.trim());
//
//				if (genre_db.addGenre(tempgenre)) {
...
//					if (count == 1) {
//						Genre tempgenre = new Genre();
//						tempgenre.setGenreID(Integer.parseInt(genreID));
//						tempgenre.setGenre(genre.trim());
//						if (genre_db.updateGenre(tempgenre)) {
